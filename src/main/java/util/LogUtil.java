...
import jp.co.lawson.mo.model.Lmv20022DownloadProcessLogInfo;
import jp.co.lawson.mo.model.Lmv23022DownloadProcessLogInfo;
import jp.co.lawson.mo.model.UserInfo;
...
public final class LogUtil {
     ...
     */
    public static void outDbaccessInfo(Lmv20022DownloadProcessLogInfo logInfo, int count, OperationType oType,
            String tableNames) {
        String type = getType(oType);
        String acction = "";
        if (oType != OperationType.PROCEDURE) {
        ...
        String msg = logInfo.getUrl() + "\t" + logInfo.getUserId() + "\t" + logInfo.getActionName();
        msg = msg + "\t" + acction;
        outTrail(msg);
    }
     ...
     * @param tableNames テーブル名
     */
    public static void outDbaccessInfo(Lmv23022DownloadProcessLogInfo logInfo, int count, OperationType oType,
            String tableNames) {
        String type = getType(oType);
        String acction = "";
        if (oType != OperationType.PROCEDURE) {

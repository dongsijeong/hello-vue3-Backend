...
public final class DateString {
    ...
    */
     ...
     * @param    endData            有効終了日
     * @return    エラーがある場合    エラーコード
     *             エラーがない場合    0
     */
    public static int checkDateRange(String startDate, String endData) {
        ...
        // スラッシュを取る
        String strStart = StringUtil.dateTOStr(startDate);
        String strEnd = StringUtil.dateTOStr(endData);

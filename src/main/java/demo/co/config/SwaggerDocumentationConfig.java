...
//                .apis(RequestHandlerSelectors.basePackage("jp.co.lawson.mo.controller")).paths(PathSelectors.any())
...
//            return new Docket(DocumentationType.OAS_30).select()
//                    .apis(RequestHandlerSelectors.basePackage("jp.co.lawson.mo.controller"))
...
//                    .apiInfo(apiInfo());
     ...
     */
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Lawson生産加工システムインターフェース定義群").description("Lawson生産加工システム").license("")
    ...
    public OpenAPI openApi() {
        return new OpenAPI()
                .info(new Info().title("Lawson生産加工システムインターフェース定義群").description("Lawson生産加工システム").termsOfService("")

...
//
//    @Value("${jwt.token.claim.iss:lawson}")
//    private String jwtIss;
//
//    @Value("${jwt.token.secret-key:jwtSECRET}")
//    private String jwtSecret;
    @Autowired
    private JWTProviderService jwtProviderService;

//    @Value("${jwt.token.claim.exp:3600}")
...
//    @Value("${Seisankako_Online_Start:0800}")
//    private String onlineStart;
//
//    @Value("${Seisankako_Online_End:2155}")
...
//     * @return ローカルパス
//     */
//    public static String getOnlineStart() {
//        return sInstance.onlineStart;
//    }
//
//    /**
//     *ローカルパスを返す。
//     * @return ローカルパス
//     */
//    public static String getOnlineEnd() {
//        return sInstance.onlineEnd;
//    }
...
//     * @return JWTヘッダー
//     */
//    public static String getJwtHeaderl() {
//        return sInstance.jwtHeader;
//    }
//
//    /**
//     * JWT発行者の取得
//     * @return JWT発行者
//     */
//    public static String getJwtIss() {
//        return sInstance.jwtIss;
//    }
//
//    /**
//     * JWTパスワードの取得
